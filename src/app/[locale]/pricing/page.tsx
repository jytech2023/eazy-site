  ...
  const plans = [
    {
      ...
      features: [
        `${PLANS.free.maxSites} ${dict.pricing.features.sites}`,
        `${PLANS.free.maxPages} ${dict.pricing.features.pages}`,
        dict.pricing.features.freeModel,
        dict.pricing.features.cloudflare,
    ...
    },
    {
      ...
      popular: true,
      features: [
        `${PLANS.pro.maxSites} ${dict.pricing.features.sites}`,
        `${PLANS.pro.maxPages} ${dict.pricing.features.pages}`,
